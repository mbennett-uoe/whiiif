...
Whiiif requires a preinstalled SOLR instance (any version 8.0-8.3.1. NB: Whiiif currently relies on an older version of the solr-ocrhighlighting plugin and as such does not work with SOLR 8.4+ yet) and installation of the [`solr-ocrhighlighting` plugin v0.3.1](https://github.com/dbmdz/solr-ocrhighlighting/releases/tag/0.3.1).
